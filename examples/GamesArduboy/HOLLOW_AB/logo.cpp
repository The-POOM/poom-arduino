...
bool updateLogo(void)
{
    ...
    Poom.leds().setColor(0, 0, signalOn * 127);
    return (counter <= 0);
}
...
void drawLogo(void)
{
    ...
    for (int i = 0; i < 3; i++) {
        ...
        Poom.drawPageBitmap(28 + i * 24, y, imgOBN + i * 96, 24, 32);
    }
    Poom.drawPageBitmap(68, 44, imgSoft, 32, 8);
    HollowPoom::printAt(16, 58, F(APP_CODE " VER " APP_VERSION));
}
