            ...
            switch (prince.getStance()) {
                ...
                case Stance::Crouch_HOP_7_End:
                    ...
                    if (prince.getCrouchingCounter() == 0) {
                        ...
                        // Either face button can use an item while crouched. B is
                        // POOM's general action button; A remains supported for
                        // players familiar with the original Arduboy controls.
                ...
                case Stance::Sword_Normal:
                        ...
                        // POOM combat controls:
                        //   B          attack
                        //   A or Up    block
                        //   Down       sheathe sword
                        // Left/Right continue to advance and retreat.
                        if (pressed & DOWN_BUTTON) {
                        ...
                        else if (pressed & (A_BUTTON | UP_BUTTON)) {
