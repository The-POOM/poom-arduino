...
void setTitleFrame(TitleFrameIndex index) {
    ...
    constexpr uint8_t TitleFrameIndexEntrySize = FX::DataAddressSize + sizeof(uint8_t);
    FX::seekDataArray(TitleFrameIndexTable, idx, 0, TitleFrameIndexEntrySize);
